...
cr.define('bmm', function() {
  ...
  function getSubtreePromise(id, foldersOnly) {
    return new Promise(function(resolve) {
      //fred
      //console.log('getSubtree',id, foldersOnly, resolve)
      //chrome.bookmarkManagerPrivate.getSubtree(id, foldersOnly, resolve);
      chrome_bookmarkManagerPrivate.getSubtree(id, foldersOnly, resolve);
    });
  }
  ...
  function addBookmarkModelListeners() {
    //fred
    chrome_bookmarks.onChanged.addListener(handleBookmarkChanged);
    chrome_bookmarks.onChildrenReordered.addListener(handleChildrenReordered);
    chrome_bookmarks.onCreated.addListener(handleCreated);
    chrome_bookmarks.onMoved.addListener(handleMoved);
    chrome_bookmarks.onRemoved.addListener(handleRemoved);
    chrome_bookmarks.onImportBegan.addListener(handleImportBegan);
    chrome_bookmarks.onImportEnded.addListener(handleImportEnded);
  };
