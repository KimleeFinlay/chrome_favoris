...
function navigateTo(id, opt_callback) {
  ...
  //fred
  //console.log('metricsId',metricsId); //< BookmarkBar, SubFolder, Other
  //chrome.metricsPrivate.recordUserAction('BookmarkManager_NavigateTo_' + metricsId);
  chrome_metricsPrivate.recordUserAction('BookmarkManager_NavigateTo_' + metricsId);
...
function processHash() {
  ...
  if (valid) {
    ...
    chrome_bookmarks.get(id, function(items) {
...
function updatePasteCommand(opt_f) {
  ...
  if (bmm.tree.selectedItem) {
    promises.push(new Promise(function(resolve) {
      ...
      chrome_bookmarkManagerPrivate.canPaste(id, function(canPaste) {
  ...
  if (bmm.list.isSearch() || !listId) {
    ...
    promises.push(new Promise(function(resolve) {
      ...
      chrome_bookmarkManagerPrivate.canPaste(listId, function(canPaste) {
...
function initializeBookmarkManager() {
  ...
  chrome_bookmarkManagerPrivate.getStrings(continueInitializeBookmarkManager);
}
